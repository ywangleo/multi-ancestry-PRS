...
tmp=("`ls ${root}/clump/profiles/single_pop/caus${M}-rep${irep}-h2_${h2}-S1_-1-${pp}_Bin1toBin${addbin}.S*.sscore | wc -l`")
...
--out ${root}/clump/profiles/single_pop/${pp}_caus${M}-rep${irep}-h2_${h2}-S1_-1-${pp}_Bin1toBin${addbin} --threads 4
else
~/plink2 --bfile /humgen/atgu1/fs03/yiwang/hapgen2/data/plink_bfiles/1kg_${pp}_qcd \
--keep /humgen/atgu1/fs03/yiwang/hapgen2/data/plink_bfiles/1kg_${pp}_10K_holdout.idlist \
--extract ${root}/clump/single_pop/caus${M}-rep${irep}-h2_${h2}-S1_-1-${pp}_Bin1toBin${addbin}.snplist \
